...
export default function ProcessWorkspace() {
  ...
  const activateByKeyboard = (event, index) => {
    if (
          ...
          >
            <article className="workspace-panel">
              ...
              <label className="workspace-meter-label">
                Profile readiness
                <span className="workspace-meter">
                  <i style={meter("92%")} />
                </span>
              </label>
              ...
              <ul className="workspace-roles">
                <li>
                  <span className="workspace-role-icon">
                    <Stethoscope size={16} weight="bold" aria-hidden="true" />
                  </span>
                  <div>
                ...
                <li>
                  <span className="workspace-role-icon">
                    <GraduationCap size={16} weight="bold" aria-hidden="true" />
                  </span>
                  <div>
          ...
          >
            <article className="workspace-panel">
              ...
              <div className="workspace-week" aria-hidden="true">
                <span>M</span>
                <span>T</span>
                <span className="is-booked">W</span>
                <span>T</span>
                <span className="is-live">F</span>
              </div>
          ...
          >
            <article className="workspace-panel">
              ...
              <div className="workspace-route" aria-hidden="true">
                ...
                <AirplaneTakeoff
                  className="workspace-route-plane"
                  size={14}
                  weight="fill"
                  aria-hidden="true"
                />
