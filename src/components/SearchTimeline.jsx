      ...
      return (
        <div className="sc-tl-asset" aria-hidden="true">
          ...
          <div className="sc-tl-prep">
            <span className="sc-tl-prep-icon">
              <Chats size={14} weight="fill" />
            </span>
            <div>
          ...
          <ul className="sc-tl-stack">
            <li className="is-done">
              <Check size={10} weight="bold" />
              CV review<em>Done</em>
            </li>
            <li className="is-next">
              <Translate size={10} weight="bold" />
              B1 drill<em>Active</em>
            </li>
          </ul>
        </div>
      );
      ...
      return (
        <div className="sc-tl-asset" aria-hidden="true">
          ...
          <ul className="sc-tl-stack">
            <li className="is-done">
              <Check size={10} weight="bold" />
              Anerkennung<em>24 May</em>
            </li>
            <li className="is-next">
              <Check size={10} weight="bold" />
              Visa appt<em>12 Jun</em>
            </li>
          </ul>
        </div>
      );
          ...
          return (
            ...
            >
              <button
                ...
                style={{
                  "--sc-tl-card-progress-duration":
                    isActive && isVisible ? `${AUTO_ADVANCE_MS}ms` : "0ms",
                }}
