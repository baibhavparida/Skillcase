...
export const blogPosts = [
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "Why Germany is a Popular Destination for Nurses",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Qualifications and Eligibility for Nursing in Germany",
      },
      ...
      {
        type: "heading",
        text: "Application Process for Nursing Jobs in Germany",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Credential Recognition and Adaptation Program",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "Why Germany is a Great Destination for Doctors",
      },
      {
        type: "list",
        items: [
